...
| 4 | Multiplayer model | Solo + cloud save + **async social** | Loop is fundamentally single-player; real-time MP is the biggest complexity multiplier. Async social gives the "friends" hook cheaply. | 2026-07-08 |
